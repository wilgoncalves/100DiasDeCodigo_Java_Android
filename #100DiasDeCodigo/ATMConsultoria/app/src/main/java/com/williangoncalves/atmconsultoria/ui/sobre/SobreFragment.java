package com.williangoncalves.atmconsultoria.ui.sobre;
...
import com.williangoncalves.atmconsultoria.R;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("williangoncalves", "Facebook")
                .addInstagram("itswilliangoncalves", "Instagram")
                .addTwitter("itswilliangoncalves", "Twitter")
                .addYoutube("williangoncalves", "Youtube")
                .addGitHub("williangoncalves", "GitHub")
